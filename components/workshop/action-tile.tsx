  ...
  const content = (
    <>
      ...
      <div className="flex min-w-0 items-start gap-3">
        <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-neutral-200 bg-neutral-100 text-neutral-700 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)]">
          {icon}
        </span>
