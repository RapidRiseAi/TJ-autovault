...
import { Bell, ChartNoAxesCombined, ClipboardList, UsersRound } from 'lucide-react';
import { cn } from '@/lib/utils';

const workshopMobileLinks = [
  { href: '/workshop/dashboard', label: 'Home', icon: ChartNoAxesCombined },
  { href: '/workshop/work-requests', label: 'Requests', icon: ClipboardList },
  { href: '/workshop/customers', label: 'Customers', icon: UsersRound },
  { href: '/workshop/notifications', label: 'Alerts', icon: Bell }
];
