...
export function WorkshopSupportTicketButton() {
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Contact support" maxWidthClass="max-w-lg">
        <form onSubmit={onSubmit} className="space-y-3">
          ...
          <textarea
            ...
            required
            className="min-h-32 w-full rounded-2xl border border-black/15 bg-white px-4 py-2.5 text-sm"
