...
function StatTile({
  ...
  return (
    <div className="relative flex h-full min-w-[162px] snap-start flex-col rounded-2xl border border-neutral-200 bg-white p-3 shadow-[0_12px_24px_rgba(17,17,17,0.06)] md:min-w-0 md:p-4">
      ...
      <p className="mt-2 max-w-full overflow-hidden text-ellipsis whitespace-nowrap text-[clamp(1.12rem,5.4vw,1.5rem)] font-bold leading-none text-neutral-900 md:text-2xl">{value}</p>
