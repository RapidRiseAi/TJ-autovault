...
export async function POST(request: NextRequest) {
  ...
  page.drawText(new Date().toLocaleDateString(), { x: rightX, y: PAGE_HEIGHT - MARGIN - 18, size: 10, font });
  ...
  page.drawText('Technician signature: ____________________', { x: MARGIN, y: cursorY, size: 11, font });
  page.drawText('Date: ____________', { x: MARGIN + 330, y: cursorY, size: 11, font });
