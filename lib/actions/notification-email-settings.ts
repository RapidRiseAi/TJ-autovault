...
function normalizeSelectionsForPlan(
  planCode: string,
  values: {
    notifyMessages: boolean;
    notifyQuotes: boolean;
  ...
  if (enabledCount <= 3) return values;
...
export async function getNotificationEmailSettings(): Promise<NotificationEmailSettings> {
  ...
  const normalizedSelections = normalizeSelectionsForPlan(planCode, {
  ...
  return {
    ...
    notifyMessages: normalizedSelections.notifyMessages,
    notifyQuotes: normalizedSelections.notifyQuotes,
    notifyInvoices: normalizedSelections.notifyInvoices,
    notifyRequests: normalizedSelections.notifyRequests,
    notifyReports: normalizedSelections.notifyReports,
    notifyRecommendations: normalizedSelections.notifyRecommendations,
    notifySystem: normalizedSelections.notifySystem,
    notifyJobUpdates: normalizedSelections.notifyJobUpdates,
    notifyPayouts: normalizedSelections.notifyPayouts,
